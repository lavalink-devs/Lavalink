...
fun VersionCatalogBuilder.voice() {
    version("lavaplayer", "895b7cd")

    library("lavaplayer",            "com.github.botlabs-gg", "lavaplayer").versionRef("lavaplayer")
    library("lavaplayer-ip-rotator", "com.github.botlabs-gg.lavaplayer", "lavaplayer-ext-youtube-rotator").versionRef("lavaplayer")
