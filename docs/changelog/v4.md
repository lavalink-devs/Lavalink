...
> The voice state has a new `channelId` field which is required to connect to the voice gateway.

* Updated Koe to [`3.0.0`](https://github.com/KyokoBot/koe/releases/tag/3.0.0) with DAVE support.
